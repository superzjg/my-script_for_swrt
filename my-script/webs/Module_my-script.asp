                                ...
                                <td bgcolor="#4D595D" colspan="3" valign="top">
                                    ...
                                    <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
                                        <tr id="switch_tr">
                                            ...
                                            <td colspan="2">
                                                ...
                                                &nbsp;&nbsp;&nbsp;<a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="open_conf('my_log');" >查看插件日志</a>
                                            </td>
                                        </tr>
                                    </table>
                                    </div>
                                    ...
                                    <table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable" style="box-shadow: 3px 3px 10px #000;margin-top: 0px;">
                                        ...
                                        <th>
                                                ...
                                                <td colspan="2">
                                                <a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="open_port();" >打开端口</a>
                                                &nbsp;<a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="close_port();" >关闭端口</a>
                                                &nbsp;<a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="query_port();open_conf('my_iptables_l');" >查看端口状态</a>
                                            </td>
                                            <tr>
                                        ...
                                        <thead>
                                         ...
                                         <tr>
                                            ...
                                            <th>
                                                ...
                                                <td colspan="2">
                                                <a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="add_cru();" >手动添加</a>
                                                &nbsp;<a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="open_conf('my_cru_l_lnk');" >查看当前</a>&nbsp;&nbsp;&nbsp;若某识别码已注册，将不会覆盖
                                            </td>
                                            <tr>
                                            ...
                                            <td>
                                                ...
                                                <a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="del_cru();" >删除此项</a>
                                            </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <thead>
                                            ...
                                            <td colspan="2">
                                                <a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="add_script();" >添加脚本</a>
                                                &nbsp;<a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="del_script();" >删除脚本</a>
                                                &nbsp;<a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="query_script_content();open_conf('my_script_c_lnk');" >查看脚本内容</a>
                                                &nbsp;<a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="query_script();open_conf('my_script_l');" >查看文件列表</a>
                                            </td>
                                            </tr>
                                            <tr>
                                              <th>
                                            ...
                                            <td>
                                                ...
                                                <a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="run_script();" >开始运行</a>
                                                &nbsp;<a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="open_conf('my_script_echo');" >查看输出</a>
                                                &nbsp;<a type="button" class="my_btn" style="cursor:pointer" href="javascript:void(0);" onclick="kill_script();" >强制停止</a>
                                            </td>
                                            </tr>
                                            <tr>
                                              <th>
